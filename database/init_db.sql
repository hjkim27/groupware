...
(
    ...
    assigned_user_sids integer[],
    view_user_sids     integer[],
    tag_sids           integer[],
    group_sid          integer,
...
comment on column tb_task.assigned_user_sids is '담당자 sid';
comment on column tb_task.view_user_sids is '글을 확인한 담당자 sid';
...
comment on column tb_task.deleted_at is '삭제일자';
